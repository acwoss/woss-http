...
class StreamTest extends TestCase
{
    ...
    public function testTellReturnsNullIfResourceIsDetached()
    {
        $this->tmpnam = tempnam(sys_get_temp_dir(), 'diac');
    ...
    public function testWriteReturnsNullWhenStreamIsDetached()
    {
        $this->tmpnam = tempnam(sys_get_temp_dir(), 'diac');
        ...
        $this->assertNull($stream->write('bar'));
    }

    public function testWriteReturnsNullWhenStreamIsNotWritable()
    {
        $stream = new Stream('php://memory', 'r');
    ...
    public function testReadReturnsNullWhenStreamIsDetached()
    {
        $this->tmpnam = tempnam(sys_get_temp_dir(), 'diac');
        ...
        $this->assertNull($stream->read(4096));
    }
    ...
    public function testGetContentsReturnsNullIfStreamIsNotReadable()
    {
        $this->tmpnam = tempnam(sys_get_temp_dir(), 'diac');
